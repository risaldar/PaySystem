 ...
 * Generated at: 2021-06-25 19:39:49 UTC
...
public final class editEmployee_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 EmployeeManager employeeManager = new EmployeeManager(); 
      ...
      try {
        ...
        // /editEmployee.jsp(34,0) name = sub type = null reqTime = true required = false fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      ...
      out.write("\n");
      out.write("    <form action=\"library/saveEmployee.jsp\" method=\"post\" name=\"employee\">\n");
      out.write("        <div class=\"login\">\n");
      out.write("            <label for=\"name\">Name:</label>\n");
      out.write("            <input class=\"field\" id=\"name\" name=\"");
      out.print(Employee.Field.name);
      out.write("\" type=\"text\" ");
      out.print( employee == null ?"":"value='"+ employee.getName() + "'");
      out.write(" />\n");
      out.write("            <br/>\n");
      out.write("            <label for=\"");
      out.print(Employee.Field.dateHired);
      out.write("\">Date Hired:</label>\n");
      out.write("            <script type=\"text/javascript\"> new tcal({'formname': 'employee', 'controlname': '");
      out.print(Employee.Field.dateHired);
      out.write("'}, A_TCALDEF);</script>\n");
      out.write("            <input class=\"calendarField\" id=\"");
      out.print(Employee.Field.dateHired);
      out.write("\" name=\"");
      out.print(Employee.Field.dateHired);
      out.write("\" type=\"text\" ");
      out.print( employee == null ? "" : "value='" + format.format(employee.getHireDate()) + "'" );
      out.write(" />\n");
      out.write("            <br/>\n");
      out.write("            <label for=\"");
      out.print(Employee.Field.fullTimeDate);
      out.write("\">Full Time Date:</label>\n");
      out.write("            <script type=\"text/javascript\">new tcal({'formname': 'employee', 'controlname': '");
      out.print(Employee.Field.fullTimeDate);
      out.write("'}, A_TCALDEF);</script>\n");
      out.write("            <input class=\"calendarField\" id=\"");
      ...
      out.print(Employee.Field.fullTimeDate);
      out.write("\" type=\"text\" ");
      out.print( employee == null ? "" : "value='" + format.format(employee.getFullTimeDate()) + "'" );
      out.write(" />\n");
      out.write("            <br/>\n");
      out.write("            <label for=\"group\">Group:</label>\n");
      out.write("            <select class=\"field\" id=\"group\" name=\"");
      out.print(Employee.Field.group);
      out.write("\">\n");
      out.write("                ");
      ...
      out.write("            <select class=\"field\" id=\"role\" name=\"");
      out.print(Employee.Field.role);
      out.write("\">\n");
      out.write("                ");
      ...
      out.write("            <input class=\"field\" id=\"userName\" name=\"");
      out.print(Employee.Field.userName);
      out.write("\" type=\"text\" ");
      out.print( employee == null ?"":"value='" + employee.getUserName() + "'");
      out.write(" />\n");
      out.write("            <br/>\n");
      out.write("            ");
 if (employee == null) {
      ...
      out.write("            <input class=\"field\" id=\"email\" name=\"");
      out.print(Employee.Field.email);
      out.write("\" type=\"text\" ");
      out.print( employee != null && employee.getEmailAddress() != null? "value=\""+employee.getEmailAddress()+"\"" :"\"\""  );
      out.write(" >\n");
      out.write("            <br/>\n");
      out.write("            <label for=\"fileNum\">File Number:</label>\n");
      out.write("            <input class=\"field\" id=\"fileNum\" name=\"");
      out.print(Employee.Field.fileNum);
      out.write("\" type=\"text\" ");
      out.print( employee != null && employee.getFileNumber() != null ? "value=\""+employee.getFileNumber() + "\"" : "\"\"" );
      out.write(" />\n");
      out.write("            <br/>\n");
      out.write("            <label for=\"active\">Active:</label>\n");
      out.write("            <input class=\"field\" id=\"active\" name=\"");
      out.print(Employee.Field.active);
      out.write("\" type=\"checkbox\" ");
      out.print( employee == null || employee != null && employee.getActiveFlag() ? "checked=\"yes\"" : "" );
      out.write(" />\n");
      out.write("            <br/>\n");
      out.write("            <label for=\"ptoAllowed\">PTO Allowed:</label>\n");
      out.write("            <input class=\"field\" id=\"ptoAllowed\" name=\"");
      out.print(Employee.Field.ptoAllowed);
      out.write("\" type=\"checkbox\" ");
      out.print( employee != null && employee.getPtoAllowed() ? "checked=\"yes\"":"");
      out.write(" />\n");
      out.write("            <br/>\n");
      out.write("            <label for=\"salaried\">Salaried:</label>\n");
      out.write("            <input class=\"field\" id=\"salaried\" name=\"");
      out.print(Employee.Field.salaried);
      out.write("\" type=\"checkbox\" ");
      out.print( employee != null && employee.getSalary() ? "checked=\"yes\"" : "");
      out.write(" />\n");
      out.write("            <br/>\n");
      out.write("            <input size='0' type=\"hidden\" readonly='readonly' class='install' name='");
      out.print(Employee.Field.id);
      out.write("' id=\"id\" value=\"");
      out.print(employee==null?-1:employee.getId());
      out.write("\" />\n");
      out.write("            <button>Submit</button>\n");
      out.write("        </div>\n");
      out.write("    </form>\n");
      out.write("    <a href='manageEmployees.jsp'>Cancel</a><br/>\n");
      out.write("\n");
      out.write("    ");
      out.print(employee == null ?"":"<button onclick=\"changePassword(" +employee.getId()+ ");\" id = \"changePWButton\">Change Password</button>");
      out.write("\n");
      out.write("    <div id=\"changePassword\"></div>\n");
      out.write("\n");
      out.write("    ");
  ...
  private boolean _jspx_meth_timeSheet_005fheadDefault_005f0(javax.servlet.jsp.PageContext _jspx_page_context)
    ...
    try {
      ...
      // /editEmployee.jsp(30,4) name = displayCalendar type = java.lang.Boolean reqTime = true required = true fragment = false deferredValue = false expectedTypeName = null deferredMethod = false methodSignature = null
      _jspx_th_timeSheet_005fheadDefault_005f0.setDisplayCalendar(true);
